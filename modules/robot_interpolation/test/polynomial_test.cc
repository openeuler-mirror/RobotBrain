...
TEST(INTERPOLATION, double_s) {
  ...
  rosc::init_VelocityProfile_Polynomial5(
      &vp, dt, s1, 0, Vmax, 0, Amax, 0, 0, time,
      rosc::VelocityprofileStopState::_velocityprofile_stop, 1);
  // rosc::Polynomial_project(&vp.polynomial_in, &vp.polynomial_mid);
  while (true) {
